...
\license
\jointwork{Amal Ahmed, Andreas Rossberg, Deian Stefan, and Conrad Watt}
...
\abstracttitle{Concurrency in Wasm}
\abstractauthor[Conrad Watt]{Conrad Watt (Nanyang TU - Singapore, SG)}
\license
